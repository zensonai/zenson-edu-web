            ...
            <div className="w-full bg-white px-4 py-5 sm:px-6 lg:px-8">
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Student information and admission details
                                </p>
                            </div>
                        ...
                        <span
                            className={`self-start sm:self-auto inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${student.status === 'active'
                            ...
                            <div className="bg-indigo-600 px-5 sm:px-7 py-6">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                    ...
                                    <div className="w-16 h-16 shrink-0 rounded-2xl bg-white flex items-center justify-center text-indigo-600 text-2xl font-bold">
                                        {profile?.fname?.charAt(0)?.toUpperCase() || user?.email?.charAt(0)?.toUpperCase()}
                                    </div>
                            ...
                            <div className="rounded-2xl border border-gray-200 p-5 sm:p-6">
                                ...
                                <div className="mt-5 space-y-4">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <span
                                            className={`text-xs font-semibold px-3 py-1 rounded-full ${student.status === 'active'
                                                ? 'bg-green-50 text-green-600'
                                                : 'bg-gray-100 text-gray-600'
                                                }`}
                                        >
